...
public class FaqPageDTO {
	private int page, skip, display, start, end, total, fno;
	...
	public String getLink(String path) {
		...
		return UriComponentsBuilder.fromPath(path).queryParam("fno", this.fno).queryParam("page", this.page)
				.queryParam("type", this.type).queryParam("display", this.display).queryParam("keyword", this.keyword)
				.toUriString();
	}
}
